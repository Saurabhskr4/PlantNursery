...
<div class="container-fluid"style="margin:0px;padding:0px;">
 <div style="height:100%; width:100%">
     <h2><center>Flowering plants</center></h2>
	 <?php
...
//-----------------------------------------------         ALL THE FLOWERS        -----------------------------------------------------------
	 	if(isset($_GET['filtersort']))
		{
			...
			if($g2==$low)
			{
				$sql="SELECT * FROM plants WHERE type='flower' ORDER BY price ASC";
				include'display.php';
			}
			...
			{
				$sql="SELECT * FROM plants WHERE type='flower' ORDER BY price DESC";
				include'display.php';
			}
			...
			{
				$sql="SELECT * FROM plants WHERE type='flower' ORDER BY stock DESC";
				include'display.php';
			}

			 else if($g2==0)
			{
				$sql="SELECT * FROM plants WHERE type='flower'";
				include'display.php';
			}
		}
        else
